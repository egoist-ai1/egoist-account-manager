...
const api: AppApi = {
  ...
  getAntigravityGodMode: () => ipcRenderer.invoke("antigravity:godMode:get"),
  setAntigravityGodMode: (enabled) => ipcRenderer.invoke("antigravity:godMode:set", { enabled }),
  regenerateAntigravityFingerprint: (accountId) => ipcRenderer.invoke("antigravity:fingerprint:regenerate", { accountId }),
  cleanAntigravityHygiene: () => ipcRenderer.invoke("antigravity:hygiene:clean"),
  warmupAllQuotaTimers: () => ipcRenderer.invoke("accounts:warmupAll"),
  warmupAccountQuotaTimer: (accountId) => ipcRenderer.invoke("accounts:warmup", { accountId }),
