...
> [!NOTE]
> На скриншотах показан интерфейс следующего обновления 3.1.6. Последняя публичная стабильная сборка — [3.1.5](https://github.com/egoist-ai1/egoist-account-manager/releases/tag/v3.1.5); неподписанный кандидат 3.1.6 не публикуется до прохождения Windows install/live gate.
